    ...
    render() {
        ...
        return (
            ...
            <div style={{marginTop:30}}>
                ...
                <Row type="flex" align="top" justify="center" ><h1 style={{color:'grey'}}>To Do List </h1></Row>
                <Row type="flex" align="bottom" justify="left" gutter={16} >
                    <Col span={8} xl={{offset:7}} xs={{offset:5}} ><Input size="large" placeholder="Enter Todo" value={this.state.value} onChange={this.handlechange} />
                </Col>
                <Col span={1} ><Button type="primary" size="large" onClick={this.handleadd}><Icon type="plus-circle" /></Button>
                </Col>
                <Col span={1} xs={{offset:2}} xl={{offset:0}}><Button type="danger" size="large" onClick={this.handledel}><Icon type="delete" style={{fontSize:20}}/></Button>
                </Col>
                </Row>
                <div style={{marginTop:100}}>
                <Row type="flex" align="bottom" justify="left">
                <Col span={12} offset={6} >
                <EList item={this.state.item}  delfun={this.handleclick} downfun={this.handledown} upfun={this.handleup}/>
                </Col>
                </Row>
                </div>
            </div>);
